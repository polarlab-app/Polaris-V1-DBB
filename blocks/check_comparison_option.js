module.exports = {
    name: "Check Comparison With Option",
    ...
    code(cache) {
        ...
        const value1 = (this.GetInputValue("value1", cache) ? this.GetInputValue("value1", cache) : this.GetOptionValue("text1", cache));
        const value2 = (this.GetInputValue("value12", cache) ? this.GetInputValue("value2", cache) : this.GetOptionValue("text2", cache));
