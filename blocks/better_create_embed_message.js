module.exports = {
    ...
    inputs: [
        ...
        },
        {
            "id": "embeds",
            "name": "Embeds",
            "description": "Acceptable Types: List, Unspecified\n\nDescription: The embeds list to update. (OPTIONAL)",
    ...
    outputs: [
        ...
        },
        {
            "id": "embeds",
            "name": "Embeds",
            "description": "Type: Object\n\nDescription: The updated embeds list.",
            "types": ["list"]
        }
    ],
    ...
    code: function(cache) {
        ...
        let embeds = this.GetInputValue("embeds", cache)
        if (!embeds) embeds = []; embeds.push(embed)

        this.StoreOutputValue(embeds, "embeds", cache)
